...
when isMainModule:
  ...
  proc op(x, y: bool): bool = x
  proc mapping(x, y: bool): bool = x xor y
  proc composition(x, y: bool): bool = x xor y
  var lsegt = initLazySegTree(newSeq[bool](2*N), op, () => false, mapping, composition, () => false)
